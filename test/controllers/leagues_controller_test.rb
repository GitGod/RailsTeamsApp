...
class LeaguesControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create league" do
    assert_difference('League.count') do
      post leagues_url, params: { league: { country: @league.country, name: @league.name, website: @league.website } }
    end
  ...
  test "should update league" do
    patch league_url(@league), params: { league: { country: @league.country, name: @league.name, website: @league.website } }
